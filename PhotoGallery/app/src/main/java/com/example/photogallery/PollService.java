...
public class PollService extends IntentService{
   ...
   // public static final String PERM_PRIVATE = "com.example.photogallery.PRIVATE";
    public static final String REQUES_CODE = "REQUEST_CODE";
    public static final String NOTIFICATIION = "NOTIFICATIION";
    ...
    protected void onHandleIntent(Intent intent){
        ...
        String lastResltId = QueryPreferences.getLastResultId(this);
        ...
        if(resultId.equals(lastResltId)){
    ...
    private void showBackgroundNotification(int requestCode,Notification notification){
        ...
        i.putExtra(REQUES_CODE,requestCode);
        i.putExtra(NOTIFICATIION,notification);
