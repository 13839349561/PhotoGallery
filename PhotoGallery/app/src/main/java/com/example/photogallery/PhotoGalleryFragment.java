...
/*
        ...
        mThumbnailDownloader.setThumbnaiDownloadedListener(
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater menuInflater){
        ...
        MenuItem toggleItem = menu.findItem(R.id.menu.item_toggle);
    ...
    private class PhotoAdapter extends RecyclerView.Adapter<PhotoHolder>{
        ...
        public void onBindViewHolder(PhotoHolder photoHolder,int position){
            ...
            //有点问题
            mThumbnailDownloader.queueThumbnail(photoHolder,galleryItem.getmUri());
        }
    ...
    private class FetchItemsTask extends AsyncTask<Void,Void,List<GalleryItem>>{
        ...
        protected List<GalleryItem> doInBackground(Void ...params){
           /* try {
                ...
                //Log.i(TAG, "Failed to fetch URL",result);
